(function() {
  (function(factory) {
    ...
    nodeToObject = function(xmlNode, mode, smartHints) {
      var attribute, childNode, i, nodeName, nodeText, objNode, parentName, _i, _j, _k, _ref, _ref1, _ref2;
      if (mode == null) {
        mode = "strict";
      }
      if (smartHints == null) {
      ...
      if (xmlNode.hasChildNodes()) {
        for (i = _k = 0, _ref2 = xmlNode.childNodes.length; 0 <= _ref2 ? _k < _ref2 : _k > _ref2; i = 0 <= _ref2 ? ++_k : --_k) {
